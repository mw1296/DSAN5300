...
Fitted weights:
$w_1 = -0.93$ | $w_2 = -0.94$ | $b = 0$

**Point A: $(x_1 = 3, x_2 = 3)$**

$$
z_A = (-0.93)(3) + (-0.94)(3) = -5.61
$$

$$
P_A = \frac{1}{1 + e^{5.61}} = 0.00365
$$
...
$$
z_B = (-0.93)(-3) + (-0.94)(-3) = 5.61
$$

$$
P_B = \frac{1}{1 + e^{-5.61}} = 0.9963
$$

**Result:**

- Point A has a low probability (~0.004) → classified as class 0
- Point B has a high probability (~0.997) → classified as class 1
