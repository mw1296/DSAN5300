...
The plot shows that with about 10 hidden units, the model already fits the training data well, and increasing beyong 10 adds complexity without meaningful improvement.
