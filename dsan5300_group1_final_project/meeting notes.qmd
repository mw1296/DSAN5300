...
![](img/logistic_regression_best_cm.png){width=50%, fig-align="left"}
...
![](img/linear_svc_best_cm.png){width=50%, fig-align="left"}


- 3. Final SVC model including resampling, cv and l1 with above selected features

![](img/final_linear_svc_best_cm.png){width=50%, fig-align="left"}
