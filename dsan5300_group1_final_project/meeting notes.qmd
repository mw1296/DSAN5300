...
### Meeting 04/03/2026
#### Discussions
- 1. Exclude below columns from full data modelling and add back to 2024 data modelling:

`SL6, I41_c, I41_e, A1_a, A1_b, A1_c, X12_a, X12_b, X12_c, X12_d, X12_e, X12_f, X12_g, EF5C`

- 2. Model accuracy should be compared with baseline model and check confusion matrix (especially recall) to make sure the accuracy is meaningfull.
...
- 1. BNPL1 - Logistic model

**selected features**

['I20_Less than your income', 'I20_More than your income',
       ...
       'ppagecat_35-44', 'ppagecat_45-54', 'ppagecat_55-64', 'ppagecat_65-74',
       'ppagecat_75+', 'B3_About the same', 'B3_Much better off',
       'B3_Much worse off', 'B3_Somewhat better off', 'B3_Somewhat worse off',
       'A6_Don’t know', 'A6_Not confident', 'A6_Somewhat confident',
       'A6_Very confident']

![](img/BNPL1_logistic_regression_best_cm.png){width=50%, fig-align="left"}
...
['EF3_d', 'EF3_f', 'I20_Less than your income',
       ...
       'ppmarit5_Widowed', 'ppagecat_18-24', 'ppagecat_25-34',
       'ppagecat_35-44', 'ppagecat_45-54', 'ppagecat_55-64', 'ppagecat_65-74',
       'ppagecat_75+', 'ppfs1482_Don’t know', 'ppfs1482_Excellent',
       'ppfs1482_Good', 'ppfs1482_Very poor', 'B3_About the same',
       'B3_Much better off', 'B3_Much worse off', 'B3_Somewhat better off',
       'B3_Somewhat worse off', 'A6_Don’t know', 'A6_Not confident',
       'A6_Somewhat confident', 'A6_Very confident',
       'C4A_Most or all of the time',
       'C4A_Never carried an unpaid balance (always pay in full)']

![](img/BNPL1_linear_svc_best_cm.png){width=50%, fig-align="left"}


- 3. BNPL1 - Final SVC model including resampling, cv and l1 with above selected features

['EF3_c', 'EF3_d', 'EF3_e', 'EF3_f', 'EF3_h', 'ppkid017',
       ...
       'C4A_Some of the time', 'L0C_1', 'L0C_2', 'L0C_3', 'L0C_4',
       'L0C_5 or more']

![](img/BNPL1_final_linear_svc_best_cm.png){width=50%, fig-align="left"}


 - 4. BNPL3 - Final Linear SVC model including resampling, cv and l1 with above selected features
...
![](img/BNPL3_linear_svc_best_cm.png){width=50%, fig-align="left"}


 - 5. BNPL1 2024 - Linear SVC

**selected features**

['EF3_a', 'EF3_c', 'EF3_d', 'EF3_e', 'EF3_f', 'EF3_g', 'EF3_h', 'ppage',
       ...
       'ppinc7_$75,000 to $99,999', 'ppinc7_Less than $10,000',
       'ppmarit5_Now married', 'ppmarit5_Separated', 'ppagecat_18-24',
       'ppagecat_25-34', 'ppagecat_35-44', 'ppagecat_55-64', 'ppagecat_65-74',
       'ppagecat_75+', 'ppfs1482_Don’t know', 'ppfs1482_Fair', 'ppfs1482_Good',
       'ppfs1482_Poor', 'ppfs1482_Very poor', 'B3_About the same',
       'B3_Much better off', 'B3_Much worse off', 'B3_Somewhat better off',
       'B3_Somewhat worse off', 'A6_Don’t know', 'A6_Very confident',
       'C4A_Most or all of the time',
       'C4A_Never carried an unpaid balance (always pay in full)', 'C4A_Once',
       'C4A_Some of the time', 'L0C_1', 'L0C_2', 'L0C_3', 'L0C_4',
       'L0C_5 or more']

![](img/2024_BNPL1_linear_svc_best_cm){width=50%, fig-align="left"}


 - 6. BNPL1 2024 - Final Linear SVC model including resampling, cv and l1 with above selected features
...
![](img/2024_BNPL1_final_linear_svc_best_cm){width=50%, fig-align="left"}

 - 7. BNPL3 2024 - Linear SVC

**selected features**

['EF3_c', 'I41_c', 'A1_a', 'A1_c', 'EF5C', 'I20_Less than your income',
...
![](img/2024_BNPL3_linear_svc_best_cm){width=50%, fig-align="left"}

 - 8. BNPL3 2024 - Final Linear SVC model including resampling, cv and l1 with above selected features
...
![](img/2024_BNPL3_final_linear_svc_best_cm){width=50%, fig-align="left"}


### Presentation Q&A preparation

- 1. why using Linear SVC for feature selection instead of non-linear?


### Meeting 04/10/2026
#### Discussions

1. Presentation day time

2. Next steps:
 - Part1. Description of the BNPL users. compare users vs. non-users; default vs. non-default. Graph, tables. chart
 - Part2. Feature selection. Feature filtered based on EDA --> PCA --> Stepwise backward feature selection
 - Part3. Modeling and model comparison: SVC, Logistic, XGBoost, NN. Experiment stack model when time allows
 - Part4. Model output explanation:
       - Logistic regression: coefficients and significance
       - SVC: SHAP, LIME
       - XGBoost: tree
       - NN: SHAP & Integreted Gradients
 - Part5. Discussions & Conclusions
